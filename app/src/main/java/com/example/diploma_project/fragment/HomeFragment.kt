...
import com.example.diploma_project.adapter.CategoryAdapter
import com.example.diploma_project.adapter.ProductAdapter
import com.example.diploma_project.databinding.FragmentHomeBinding
    ...
    private fun getProducts() {
        ...
        Firebase.firestore.collection("products")
            .get().addOnSuccessListener {
                ...
                binding.productRecycaler.adapter = ProductAdapter(requireContext(), list)
            }
    }
    ...
    private fun getCategory() {
        ...
        Firebase.firestore.collection("category")
            .get().addOnSuccessListener {
                ...
                binding.categoryRecycaler.adapter = CategoryAdapter(requireContext(), list)
            }
    }
